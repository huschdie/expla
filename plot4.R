...
relevant.data$Voltage <- as.numeric(as.character(relevant.data$Voltage))
relevant.data$Global_reactive_power <- as.numeric(as.character(relevant.data$Global_reactive_power))
...
plot(x = relevant.data$ts,y = relevant.data$Voltage, type = "l",
...
plot(x = relevant.data$ts,y = relevant.data$Global_reactive_power, type = "l",
